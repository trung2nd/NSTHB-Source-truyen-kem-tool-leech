...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="Truyen.TroLyFacebook.Com">
		...
		<script type="application/ld+json">
		{
		    ...
		    "@type": "WebSite",
		    "url": "https://truyen.trolyfacebook.com/",
		    "name": "Doc truyen online 24h",
		    "alternateName": "Truyen Tong Hop"
		    "potentialAction": {
		      "@type": "SearchAction",
		      "target": "https://truyen.trolyfacebook.com/?s={search_term_string}",
    ...
    <body class="page-container-bg-solid page-sidebar-closed-hide-logo">
        ...
        <div class="page-header navbar">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
                    <a title="Đọc truyện Online" href="https://truyen.trolyfacebook.com">
